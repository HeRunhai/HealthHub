			...
			<view class="u-select">
				...
				<view class="u-select__body">
					 ...
					 <scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-Y">
					 	<!--单选-->
					 	<u-radio-group class="flex diy-select flex-wrap diygw-col-24 flex-direction-column justify-between" wrapClass="flex-direction-column" :activeColor="activeColor" v-if="mode == 'radio'" :borderBottom="true" iconPlacement="right" placement="column"
					 		@change="radioChange" >
